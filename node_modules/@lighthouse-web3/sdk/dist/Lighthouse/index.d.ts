...
declare const _default: {
    ...
    uploadEncrypted: (path: any, apiKey: string, publicKey: string, signedMessage: string, dealParameters?: import("../types").DealParameters | undefined, uploadProgressCallback?: ((data: any) => void) | undefined) => Promise<{
